...
function Glow() {
  ...
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden bg-red-950 lg:right-[calc(max(2rem,50%-38rem)+40rem)] lg:min-w-[32rem]">
      <svg
      ...
      >
        <defs>
          <radialGradient id={`${id}-desktop`} cx="100%">
            ...
            <stop offset="53.95%" stopColor="rgba(0, 0, 0, 0.09)" />
